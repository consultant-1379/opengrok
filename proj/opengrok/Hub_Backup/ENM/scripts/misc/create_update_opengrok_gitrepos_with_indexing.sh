...
set_environment_variables()
{
	...
	MAIL_USERS="sonesh.kumar.malhotra@ericsson.com,rahul.chhabra@ericsson.com"
}
...
OPENGROK_WEBAPP_CONTEXT=/enm-opengrok  OPENGROK_VERBOSE=true /proj/opengrok/tools/opengrok/opengrok-0.12.1.5/bin/OpenGrok index /proj/opengrok/ENM-Repos/src/
