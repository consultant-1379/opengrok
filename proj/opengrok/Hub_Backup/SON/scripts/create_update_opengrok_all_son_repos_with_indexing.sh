...
#Required first time only
clone_sonom_testware_17B()
{
        TESTWARE17B="OSS/com.ericsson.son.sonom.test/testware"
        cd /proj/opengrok/SON-ALL-Repos/src/testware-17B
        git clone -b 17B ${GERRIT_MIRROR}/$TESTWARE17B
}

pull_sonom_testware_17B()
{
        cd /proj/opengrok/SON-ALL-Repos/src/testware-17B/testware
        TESTWARE17B="OSS/com.ericsson.son.sonom.test/testware"
        git pull ${GERRIT_MIRROR}/${TESTWARE17B} 17B
}
